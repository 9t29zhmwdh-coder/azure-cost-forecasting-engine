# Copilot Instructions for Azure Cost Forecasting Engine
A command-line tool that analyzes historical Azure consumption data, forecasts the next 30, 60 and 90 days of cloud spend, detects cost anomalies, and generates prioritized optimization recommendations. Compatible with the Microsoft FinOps Framework, using pure Python with standard-library math only.
## Code style
